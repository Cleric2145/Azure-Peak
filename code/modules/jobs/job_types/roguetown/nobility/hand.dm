...
/datum/outfit/job/roguetown/hand/advisor/pre_equip(mob/living/carbon/human/H)
	...
	armor = /obj/item/clothing/suit/roguetown/armor/leather/vest/hand
	pants = pick(/obj/item/clothing/under/roguetown/tights/black, /obj/item/clothing/under/roguetown/tights/red, /obj/item/clothing/under/roguetown/tights/purple)
	if(H.mind)
